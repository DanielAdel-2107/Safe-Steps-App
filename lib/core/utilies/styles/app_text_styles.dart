...
import 'package:safe_steps/core/helper/get_responsive_font_size.dart';
...
class AppTextStyles {
  static TextStyle title20WhiteW500 = TextStyle(
    ...
    static TextStyle title22WhiteW500 = TextStyle(
  ...
  static TextStyle title14White = TextStyle(
    ...
    static TextStyle title14WhiteW500 = TextStyle(
    color: Colors.white,
    fontWeight: FontWeight.w500,
    fontSize: getResponsiveFontSize(fontSize: 14),
  );
  ...
  static TextStyle title18BlackW400 = TextStyle(
    color: Colors.black,
    fontSize: getResponsiveFontSize(fontSize: 18),
  );
  ...
  static TextStyle title24FourthColorW500 = TextStyle(
  ...
  static TextStyle title28WhiteColorWithOpacity = TextStyle(
  ...
  static TextStyle title16PrimaryColorW500Underline = TextStyle(
    color: AppColors.kPrimaryColor,
    fontSize: getResponsiveFontSize(fontSize: 16),
  ...
  static TextStyle title18GreyW500 = TextStyle(
    ...
    static TextStyle title18GreyW400 = TextStyle(
  ...
  static TextStyle title16Grey = TextStyle(
    ...
    static TextStyle title18GreyShade300 = TextStyle(
    color: Colors.grey.shade300,
    fontSize: getResponsiveFontSize(fontSize: 18),
  );

  static TextStyle title17Grey500 = TextStyle(
